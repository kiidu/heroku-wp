...
<header class="banner headerclass" itemscope itemtype="http://schema.org/WPHeader">
	...
	if ( ! empty( $virtue['virtue_banner_upload']['url'] ) ) {
		...
		if ( isset( $virtue['virtue_banner_upload']['id'] ) && ! empty( $virtue['virtue_banner_upload']['id'] ) ) {
			$banner_alt = get_post_meta( $virtue['virtue_banner_upload']['id'], '_wp_attachment_image_alt', true );
		} else {
			$banner_alt = '';
		}
	?>
	<div class="container">
		<div class="virtue_banner">
			<img alt="<?php echo esc_attr( $banner_alt ); ?>" src="<?php echo esc_url( $banner_image ); ?>" />
		</div>
	</div>
	<?php } ?>
</header>
