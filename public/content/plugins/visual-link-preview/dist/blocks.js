var VisualLinkPreview = VisualLinkPreview || {}; VisualLinkPreview["blocks"] =
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__admin_encoder__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__admin_form_field_type__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__admin_form_field_post__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__admin_form_field_url__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__admin_form_field_template__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__css_blocks_blocks_scss__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__css_blocks_blocks_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__css_blocks_blocks_scss__);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var formattingControls = ['bold', 'italic', 'strikethrough'];
...
registerBlockType('visual-link-preview/link', {
	...
	edit: function (_Component) {
		...
		_createClass(edit, [{
			...
			value: function componentWillUpdate(nextProps) {
				...
				var encoded = Object(__WEBPACK_IMPORTED_MODULE_0__admin_encoder__["b" /* encodeLink */])(link);
			...
			value: function render() {
				...
				var imageBlock = React.createElement(
					'div',
					{ className: attributes.image_id ? 'image-selected' : 'no-image' },
					React.createElement(MediaUpload, {
						...
						render: function render(_ref) {
							...
							return React.createElement(
								Button,
								{ className: attributes.image_id ? 'image-button' : 'components-button button button-large', onClick: open },
								attributes.image_id ? React.createElement('img', { src: attributes.image_url }) : __('Choose Image')
							);
						}
					}),
					attributes.image_id && isSelected && React.createElement(
						'a',
						{ onClick: function onClick(e) {
								e.preventDefault();e.stopPropagation();setAttributes({ image_id: null, image_url: null });
							} },
						'(remove)'
					)
				);
				...
				return [React.createElement(
					...
					(attributes.summary || isSelected) && React.createElement(RichText, {
						tagName: 'div',
						multiline: 'p',
						placeholder: 'Summary for the link',
						value: attributes.summary,
						onChange: function onChange(nextValue) {
							return setAttributes({ summary: nextValue });
						},
						formattingControls: formattingControls
					}),
					...
					'div',
					{ key: 'settings', className: 'vlp-form' },
					React.createElement(__WEBPACK_IMPORTED_MODULE_1__admin_form_field_type__["a" /* default */], { value: attributes.type, onChangeField: function onChangeField(value) {
							return setAttributes({ type: value });
						} }),
					attributes.type === 'internal' ? React.createElement(__WEBPACK_IMPORTED_MODULE_2__admin_form_field_post__["a" /* default */], {
						value: {
							id: attributes.post,
						...
						updateCachedPosts: function updateCachedPosts() {}
					}) : React.createElement(__WEBPACK_IMPORTED_MODULE_3__admin_form_field_url__["a" /* default */], { value: attributes.url, onChangeField: function onChangeField(e) {
							return setAttributes({ url: e.target.value });
						} }),
					React.createElement(__WEBPACK_IMPORTED_MODULE_4__admin_form_field_template__["a" /* default */], { value: attributes.template, onChangeField: function onChangeField(value) {
	...
	save: function save(_ref2) {
		...
		return React.createElement(
			'div',
			{ className: className },
			attributes.image_url && React.createElement('img', { className: 'vlp-image', src: attributes.image_url }),
			React.createElement(
				'h3',
				null,
				attributes.title
